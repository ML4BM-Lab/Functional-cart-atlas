...
# %% Figure 1D and 1E - Milopy Complete Response and Memory Phenotype
...
milopl.plot_nhood_graph(
    adata2, alpha=0.01, min_size=2, save="Figura1D.pdf"  ## SpatialFDR level (1%) --- Size of smallest dot
)
...
plt.ylabel("")
plt.tight_layout()
plt.savefig("Figura1E.pdf", dpi=300)
