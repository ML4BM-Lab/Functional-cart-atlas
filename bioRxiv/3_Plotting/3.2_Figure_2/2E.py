...
# %% Figure 2Ea - Create the dummy column to separate IACs from the rest
...
# %% Figure 2Ea - Create and save plots
sc.pl.stacked_violin(adata, var_names=Genes_IACs_vs_Rest, groupby='IACs_dummy', title="", use_raw=True, save="2Ea.pdf", vmax=3)

# %% Figure 2Eb - Filter and only keep IACs
adata2 = adata_orig.copy()
adata2 = adata2[adata2.obs["manual_celltype_annotation_high"] == "Monocyte-like T cells"]
adata2

# %% Figure 2Eb - Create the dummy column to separate pre- and post-Infusion
...
# %% Figure 2Eb - Create and save plots
sc.pl.stacked_violin(adata2, var_names=Genes_IACs_vs_Rest, groupby='IACs_dummy', title="", use_raw=True, save="2Eb.pdf", vmax=3)
