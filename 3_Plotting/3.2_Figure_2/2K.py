...
sc.pl.stacked_violin(adata_scFv1, var_names=Genes_cyto, groupby='Product_norm', use_raw=True, vmax=5, save="2K_BCMA.pdf")

# Filter scFv == "CD19"
adata_scFv2 = adata_filtered[adata_filtered.obs['ScFv'] == "CD19"].copy()
sc.pl.stacked_violin(adata_scFv2, var_names=Genes_cyto, groupby='Product_norm', use_raw=True, vmax=5, save="2K_CD19.pdf")
