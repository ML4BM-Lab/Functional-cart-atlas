...
# Program: Supplementary_Table_12.R
...
comparison
setwd("/home/scamara/data_a/scamara/Atlas/Resultados_V5/Supplementary_Table_12")
write.csv(comparison, "Supplementary_Table_12.csv")
