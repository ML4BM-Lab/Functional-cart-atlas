...
_generated_input_paths = {
    project_dir / "Resultados" / "Joined_datasets" / "Integration" / "Subclustering_V4" / "adata_CD4.h5ad",
}
...
if Save_h5ad:
    ...
    adata_CD4 = sc.read_h5ad(_input_path(_current_dir, "adata_CD4.h5ad"))
...
if Save_h5ad:
    _current_dir = Path(project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Subclustering_V4')
    adata_CD4.write(_output_path(_current_dir, "adata_CD4_state1.h5ad"))
    print("Correctly saved")
else:
    _current_dir = Path(project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Subclustering_V4')
    adata_CD4 = sc.read_h5ad(_input_path(_current_dir, "adata_CD4_state1.h5ad"))
...
if False:
    ...
    ADATA_PATH = _require_path(project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Subclustering_V4' / 'adata_CD4_state1.h5ad')
    CLUSTREE_OUT = project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Subclustering_V4' / 'Clustree_res' / 'clustree_CD4.png'
...
_current_dir = Path(project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Plots' / 'V4' / 'Subclustering' / 'CD4')
...
_current_dir = Path(project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Plots' / 'V4' / 'Subclustering' / 'CD4' / 'GSA')
_current_dir.mkdir(parents=True, exist_ok=True)
sc.settings.figdir = _current_dir
...
output_directory = project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Plots' / 'V4' / 'Subclustering' / 'CD4' / 'GSA'
...
_current_dir = Path(project_dir / 'Resultados' / 'Joined_datasets' / 'Integration' / 'Subclustering_V4' / 'Data' / 'CD4')
adata_CD4.obs["manual_celltype_annotation_high"].to_csv(_output_path(_current_dir, "adata_CD4_manual_celltype_annotation_high.csv"))
