...
.current_dir <- file.path(project_dir, "Shiny_app")
inpFile <- .input_path(.current_dir, "Python_scVI_adata_big_V4_state4_Normalized_for_shiny.h5ad")
shiny_output_dir <- file.path(.current_dir, "shinyAtlas")
