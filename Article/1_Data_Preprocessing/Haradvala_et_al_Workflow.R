...
if (FALSE) {
    ...
    if (FALSE) {
        ...
        saveRDS(Seurat_list_Haradvala, .output_path(.current_dir, "Seurat_list_Haradvala.RDS"))
    } else {
        Seurat_list_Haradvala <- readRDS(.input_path(.current_dir, "Seurat_list_Haradvala.RDS"))
    }
    ...
    .current_dir <- file.path(project_dir, "Datasets", "Haradhvala_et_al", "Downloaded_data", "Authors_Metadata_Reduced")
    Filtered_reduced_authors_meta <- read.csv(.input_path(.current_dir, "Haradvala_filtered_metadata.csv"), row.names = 1)
    ...
    saveRDS(Seurat_list_Haradvala, .output_path(.current_dir, "Seurat_list_Haradvala_inicio.RDS"))
}
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Ncells.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Knee_plots.pdf"))
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_UMIs_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Genes_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Mito_ratio_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)

# Visualize the distribution of complexity per cell
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Complexity_per_cell.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Vln_plots.pdf"))
p_Vln
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_nGenes_vs_nUMI.pdf"))
p1
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Pre_QC_mitoRatio_vs_nUMI.pdf"))
p1
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Doublet_Finder_pK_calculation.pdf"))
h1
dev.off()
rm(i, h1)
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Doublet_Finder_Classification.pdf"))
h2
dev.off()
rm(i, h2)
...
# Visualize the number of cell counts per sample
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Post_QC_Ncells.pdf"))
merged_metadata_df %>%
    ggplot(aes(x = Product, fill = Product)) +
    geom_bar() +
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Post_QC_UMIs_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Post_QC_Genes_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Post_QC_Mito_ratio_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Post_QC_Vln_plots.pdf"))
p_Vln
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Exploratory_analysis", "Post_QC_nGenes_vs_nUMI.pdf"))
p1
dev.off()
...
saveRDS(Seurat_list_Haradvala, file = .output_path(.current_dir, "PostQC_CellRanger_Haradvala_RDS.rds"))

##### Normalization #####

# rm(list = ls())
.current_dir <- file.path(project_dir, "Resultados", "Haradvala_et_al", "RDS")
Seurat_list_Haradvala <- readRDS(.input_path(.current_dir, "PostQC_CellRanger_Haradvala_RDS.rds"))
...
saveRDS(Seurat_list_Haradvala, file = .output_path(.current_dir, "Normalized_CellRanger_Haradvala_RDS.rds"))
...
# Plot UMAP
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Worst_case_scenario", "WO_integ_Seurat.pdf"))
...
pdf(.output_path(project_dir, "Resultados", "Haradvala_et_al", "Plots", "Worst_case_scenario", "QC_metrics_WO_integ_Seurat.pdf"))
