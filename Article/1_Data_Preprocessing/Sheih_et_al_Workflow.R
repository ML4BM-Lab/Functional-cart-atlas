...
.current_dir <- file.path(project_dir, "Resultados", "Sheih_et_al", "Count_Matrices", "Cell_Ranger")
Patient_list <- gsub("_Sheih_et_al", "", gsub("run_", "", dir(path = .current_dir)[dir(path = .current_dir) %>% grep(pattern = "^run_")]))
...
for (contador in Patient_list) {
    cell_ranger_dir <- file.path(.current_dir, paste0("run_", contador, "_Sheih_et_al/outs/filtered_feature_bc_matrix"))
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Ncells.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Knee_plots.pdf"))
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_UMIs_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Genes_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Mito_ratio_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)

# Visualize the distribution of complexity per cell
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Complexity_per_cell.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Vln_plots.pdf"))
p_Vln
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_nGenes_vs_nUMI.pdf"))
p1
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Pre_QC_mitoRatio_vs_nUMI.pdf"))
p1
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Doublet_Finder_pK_calculation.pdf"))
h1
dev.off()
rm(i, h1)
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Doublet_Finder_Classification.pdf"))
h2
dev.off()
rm(i, h2)
...
# Visualize the number of cell counts per sample
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Post_QC_Ncells.pdf"))
merged_metadata_df %>%
    ggplot(aes(x = Product, fill = Product)) +
    geom_bar() +
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Post_QC_UMIs_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Post_QC_Genes_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Post_QC_Mito_ratio_per_cell.pdf"))
pt_h
dev.off()
rm(i, pt_h)
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Post_QC_Vln_plots.pdf"))
p_Vln
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Exploratory_analysis", "Post_QC_nGenes_vs_nUMI.pdf"))
p1
dev.off()
...
saveRDS(Seurat_list_Sheih, file = .output_path(.current_dir, "PostQC_CellRanger_Sheih_RDS.rds"))

##### Normalization #####

# rm(list = ls())
.current_dir <- file.path(project_dir, "Resultados", "Sheih_et_al", "RDS")
Seurat_list_Sheih <- readRDS(.input_path(.current_dir, "PostQC_CellRanger_Sheih_RDS.rds"))
...
saveRDS(Seurat_list_Sheih, file = .output_path(.current_dir, "Normalized_CellRanger_Sheih_RDS.rds"))
...
# Plot UMAP
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Worst_case_scenario", "WO_integ_Seurat.pdf"))
...
pdf(.output_path(project_dir, "Resultados", "Sheih_et_al", "Plots", "Worst_case_scenario", "QC_metrics_WO_integ_Seurat.pdf"))
