...
.current_dir <- file.path(project_dir, "Resultados", "Li_X_et_al", "Count_Matrices", "Cell_Ranger")
Patient_list <- gsub("_Li_X", "", gsub("run_", "", dir(path = .current_dir)[dir(path = .current_dir) %>% grep(pattern = "^run_")]))
Patient_list

Seurat_list_Li_X <- list()
for (contador in Patient_list) {
    cell_ranger_dir <- file.path(.current_dir, paste0("run_", contador, "_Li_X/outs/filtered_feature_bc_matrix"))
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Ncells.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Knee_plots.pdf"))
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_UMIs_per_cell.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Genes_per_cell.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Mito_ratio_per_cell.pdf"))
merged_metadata_df %>%
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_Vln_plots.pdf"))
p_Vln
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Pre_QC_nGenes_vs_nUMI.pdf"))
p1
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Doublet_Finder_pK_calculation.pdf"))
h1
dev.off()
rm(i, h1)
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Doublet_Finder_Classification.pdf"))
h2
dev.off()
rm(i, h2)
...
# Visualize the number of cell counts per sample
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Post_QC_Ncells.pdf"))
merged_metadata_df %>%
    ggplot(aes(x = Product, fill = Product)) +
    geom_bar() +
    geom_text(stat = "count", aes(label = after_stat(count)), vjust = -0.5, size = 4) +
...
# Visualize the number UMIs/transcripts per cell
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Post_QC_UMIs_per_cell.pdf"))
merged_metadata_df %>%
    ggplot(aes(color = Product, x = nCount_RNA, fill = Product)) +
    geom_density(alpha = 0.2) +
    scale_x_log10() +
...
# Visualize the distribution of genes detected per cell
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Post_QC_Genes_per_cell.pdf"))
merged_metadata_df %>%
    ggplot(aes(color = Product, x = nFeature_RNA, fill = Product)) +
    geom_density(alpha = 0.2) +
    theme_classic() +
...
# Visualize the distribution of mitochondrial gene expression detected per cell
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Post_QC_Mito_ratio_per_cell.pdf"))
merged_metadata_df %>%
    ggplot(aes(color = Product, x = mitoRatio, fill = Product)) +
    geom_density(alpha = 0.2) +
    scale_x_log10() +
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Post_QC_Vln_plots.pdf"))
p_Vln
dev.off()
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Exploratory_analysis", "Post_QC_nGenes_vs_nUMI.pdf"))
p1
dev.off()
...
saveRDS(Seurat_list_Li_X, file = .output_path(.current_dir, "PostQC_CellRanger_Li_RDS.rds"))

##### Normalization #####

# rm(list = ls())
.current_dir <- file.path(project_dir, "Resultados", "Li_X_et_al", "RDS")
Seurat_list_Li_X <- readRDS(.input_path(.current_dir, "PostQC_CellRanger_Li_RDS.rds"))
...
saveRDS(Seurat_list_Li_X, file = .output_path(.current_dir, "Normalized_CellRanger_Li_RDS.rds"))
...
# Plot UMAP
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Worst_case_scenario", "WO_integ_Seurat.pdf"))
...
pdf(.output_path(project_dir, "Resultados", "Li_X_et_al", "Plots", "Worst_case_scenario", "QC_metrics_WO_integ_Seurat.pdf"))
