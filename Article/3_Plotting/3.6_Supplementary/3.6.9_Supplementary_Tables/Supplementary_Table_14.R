...
.generated_input_paths <- c(
    file.path(project_dir, "Resultados_V5", "BCMA_vs_CD19_IP_All", "Final_result_Fig_5C_IP.csv"),
    file.path(project_dir, "Resultados_V5", "BCMA_vs_CD19_MID", "Final_result_Fig_5C_MID.csv")
)
