...
Final_result_orig <- readRDS(.input_path(.current_dir, "Final_result_orig_main.RDS"))
res.compare <- readRDS(.input_path(.current_dir, "res_compare.RDS"))
...
## Deltas
Final_result_orig[Final_result_orig$Geneset=="Cytotoxicity",]
