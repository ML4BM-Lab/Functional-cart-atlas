...
saveRDS(res_all, file = .output_path(.current_dir, "Resultados_V5_BCMA_vs_CD19_IP_All.RDS"))

head(res_1)

.current_dir <- file.path(project_dir, "Resultados_V5", "BCMA_vs_CD19_IP_All")
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Heatmap.pdf"), width = 10, height = 10)
...
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Volcano.pdf"), width = 10, height = 10)
...
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Biological_Process_1.pdf"), width = 10, height = 10)
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Biological_Process_2.pdf"), width = 10, height = 10)
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_KEGG_2021_Human_1.pdf"), width = 10, height = 10)
plotZenithResults(res.zenith)
dev.off()
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_KEGG_2021_Human_2.pdf"), width = 10, height = 10)
plotZenithResults(df, Inf, Inf)
dev.off()
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Reactome_2022_1.pdf"), width = 10, height = 10)
plotZenithResults(res.zenith)
dev.off()
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Reactome_2022_2.pdf"), width = 10, height = 10)
plotZenithResults(df, Inf, Inf)
dev.off()
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_WikiPathway_2023_Human_1.pdf"), width = 10, height = 10)
plotZenithResults(res.zenith)
dev.off()
...
# plot results, but with no limit based on the highest/lowest t-statistic
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_WikiPathway_2023_Human_2.pdf"), width = 10, height = 10)
plotZenithResults(df, Inf, Inf)
dev.off()
...
# plot results, but with no limit based on the highest/lowest t-statistic
.current_dir <- file.path(project_dir, "Resultados_V5", "BCMA_vs_CD19_IP_All")
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Custom_Genesets.pdf"), width = 10, height = 10)
plotZenithResults(res.zenith)
dev.off()
...
.current_dir <- file.path(project_dir, "Resultados_V5", "BCMA_vs_CD19_IP_All")
if(TRUE){
  write.csv(Final_result, .output_path(.current_dir, "Final_result_Fig_5C_IP.csv"), row.names = FALSE)
} else{
  Final_result <- read.csv(.input_path(.current_dir, "Final_result_Fig_5C_IP.csv"))
}
...
# Plot results, but with no limit based on the highest/lowest t-statistic
.current_dir <- file.path(project_dir, "Resultados_V5", "BCMA_vs_CD19_IP_All")
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Final_Summarized_Result_1.pdf"), width=10, height = 10)
p6
dev.off()
...
# Horizontal dotplot
cairo_pdf(.output_path(.current_dir, "BCMA_vs_CD19_IP_All_Final_Summarized_Result_2.pdf"), width=10, height = 10)
