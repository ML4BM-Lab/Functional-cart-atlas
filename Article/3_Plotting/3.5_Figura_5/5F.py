...
Genes_eff = [
  "TRAC", "CD3D", "CD48",
  "GRAP2", "PDLIM2", "STK17B", "SLFN5",
  "IL32", "LTB",
  "EOMES", "CXCR6",
  "NCR3", "HCST", "CTSW",
  "IRF1", "ISG15", "GBP5"
] # Summarized to 17 genes so it can be informative.


# Filter scFv == "BCMA"
adata_scFv1 = adata_filtered[adata_filtered.obs['ScFv'] == "BCMA"].copy()
sc.pl.stacked_violin(adata_scFv1, var_names=Genes_eff, groupby='Product_norm', use_raw=True, vmax=5, save="5F_BCMA.pdf")

# Filter scFv == "CD19"
adata_scFv2 = adata_filtered[adata_filtered.obs['ScFv'] == "CD19"].copy()
sc.pl.stacked_violin(adata_scFv2, var_names=Genes_eff, groupby='Product_norm', use_raw=True, vmax=5, save="5F_CD19.pdf")
